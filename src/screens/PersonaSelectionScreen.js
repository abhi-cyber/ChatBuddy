...
import { PERSONA_TYPES, PERSONA_DETAILS, DEFAULT_PERSONA } from '../utils/personaConstants';
import { setPersona } from '../services/geminiService';

const PERSONA_STORAGE_KEY = 'GenZTherapist_SelectedPersona';
    ...
    return (
      ...
      >
        ...
        <View style={styles.sampleContainer}>
          <View style={[styles.sampleBubble, { backgroundColor: persona.bubbleColor }]}>
            <Text 
